...
## Consequences of computer storage / arithmetic
  ...
  How much storage if we store $10^6$ SNPs (single nucleotide polymorphisms) of $1000$ individuals as single (4GB), double (8GB), int32 (4GB), int16 (2GB), int8 (1GB), PLINK library format 2big/SNP (250MB)?
...
Checkout [Google's R style Guide](https://google.github.io/styleguide/Rguide.html) and [Style guide in Advanced R](http://adv-r.had.co.nz/Style.html#undefined).
