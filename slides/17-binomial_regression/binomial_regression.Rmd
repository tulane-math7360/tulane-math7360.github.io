...
- Presentation: 
    ...
    - Date: November 16, 18, 20 and 23 (week 14 and 15).
    
    - Format: 10min presentation + 5min questions
    ...
    library(faraway)
    set.seed(7360)
    students <- c("Do, Linh", "Ferranti, Dana", "Lee, Sang-Eun", "Li, Ophelia", 
                  "Martinez Pabon, Valentina", "Mayberry, Caroline", "McKee, Jae",
                  "Moody, Marcus", "Nass, Louis", "Qie, Langyu", "Stuart, Ashley",
                  "Wendell, Max") %>%
      sample() %>%
      matrix(3, 4, byrow = TRUE, dimnames = list(c("1st", "2nd", "3rd"), c("Nov 16", "Nov 18", "Nov 20", "Nov 23"))) %>%
      as_tibble(rownames = NA) %>%
      print()
    ```

- Mid-term report (2 - 4 pages) by the end of week 12, [reference lecture note](https://ucla-biostat-200c-2020spring.github.io/slides/04-binomial/binomial.html)
