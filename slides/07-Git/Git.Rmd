...
## Announcement
 ...
 - Project descriptions are looking really good.
 
 - Lab 3 [solutions](https://tulane-math7360.github.io//slides/lab-03-Functions/lab_03_Solutions.html)
 
 - [HW1](https://github.com/tulane-math7360/tulane-math7360.github.io/blob/master/HW/HW1/HW1_Fall_2020.pdf) typo corrected, due Friday
 
 - [Example HW1 RMarkdown File](https://github.com/tulane-math7360/tulane-math7360.github.io/blob/master/HW/HW1/HW1_XJ.Rmd)
 
 - [Dr. Hua Zhou's Lecture](https://ucla-biostat203b-2020winter.github.io/slides/04-git/git.html)
...
- Initialize a project.
    ...
    - Create a repository, e.g., `tulane-math7360` on GitHub.
    
    - Clone the repository to your local machine:
    ```{bash, eval=FALSE}
    git clone https://github.com/tulane-math7360/Math-7360-Xiang-Ji.git
    ```
...
- Create a private repository `Math-7360-FirstName-LastName` on `tulane-math7360`.
