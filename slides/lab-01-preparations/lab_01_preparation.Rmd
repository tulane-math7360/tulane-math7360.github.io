...
- Remember to [_introduce_ yourself](https://tulane.instructure.com/courses/2220410/discussion_topics/13092570?module_item_id=30306032) on Canvas.

- [Course GitHub organization](https://github.com/tulane-math7360)

- [Course GitHub website](https://tulane-math7360.github.io/)
...
Once you have got your GitHub id, please tell me through email or simply add that to your self-introduction on Canvas.
Your GitHub id will then be invited to the [course GitHub organization](https://github.com/tulane-math7360).

Our course has a GitHub page now.
Please take a look at [tulane-math7360.github.io](https://tulane-math7360.github.io/) and its source code at [https://github.com/tulane-math7360/tulane-math7360.github.io](https://github.com/tulane-math7360/tulane-math7360.github.io).
You could check all the development history of this website through the [commit history](https://github.com/tulane-math7360/tulane-math7360.github.io/commits/master).

## R
Install [R](https://www.r-project.org/) on your computer.
This is the worhorse for R programs.
